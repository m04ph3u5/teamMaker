	...
	<section>
		<div class="container">
			<div class="row">
				...
				<h4>Your request was accepted. Every member of team will receive an email: in order to confirm partecipation to this group, each member must click on link attached in email.</h4>
				<h4>After that all teammate will confirmed their partecipation, you can see your group on <a href="/">home page</a>.</h4>		
